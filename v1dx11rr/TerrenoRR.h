...
public:
	TerrenoRR(int ancho, int alto, ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext)
	{
		...
		//aqui cambiamos el heightmap que es el mapa de alturas
		//y es la otra textura que se va a combinar tomando forma del heightmap
		CargaParametros(L"piedra.jpg", L"Assets/noSpecMap.jpg", 70.0f);
	}
